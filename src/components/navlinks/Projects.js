          ...
          <Row>
            ...
            <Col xs={12} md={6} className="card-pad">
              <Card className="large" actions=
                ...
                revealIcon={<Icon> more_vert</Icon>}>
                <p className="Card-About re-text">In this project I used AJAX to make a request to an external Animal Crossing data source.</p>
            ...
            <Col xs={12} md={6} className="card-pad">
              <Card className="large" actions=
                ...
                revealIcon={<Icon> more_vert</Icon>}>
                <p className="Card-About re-text">This was a full CRUD MERN Stack application I made with two other female developers.</p>
            ...
            <Col xs={12} md={6} className="card-pad">
              <Card className="large" actions=
                ...
                revealIcon={<Icon> more_vert</Icon>}>
                <p className="Card-About re-text">An collaborative full CRUD application developed using PHP back-end and React front-end. Made for tracking jobs.</p>
